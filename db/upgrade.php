 ...
 *
 * @package    ltiservice_testservice
...
/**
 * xmldb_ltiservice_testservice_upgrade is the function that upgrades
 ...
 * @return boolean
 */
function xmldb_ltiservice_testservice_upgrade($oldversion) {
